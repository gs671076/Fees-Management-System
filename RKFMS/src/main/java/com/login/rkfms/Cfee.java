 ...
 * @author gs671
 */
public class Cfee extends JFrame implements ActionListener{
           JButton back,submit;
    Cfee()
    {
    initComponents();
   ...
   l_cn=new JLabel("Updated Course FEE");
   ...
   setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    ...
    try {
            ...
            String url = "jdbc:mysql://127.0.0.1:3306/rkfms?zeroDateTimeBehavior=CONVERT_TO_NULL";
            Connection con = DriverManager.getConnection(url, "root", "gaurav@123");
            String sql ="update course set Cost='"+txt_cn.getText()+"'"+"where ID ="+(id1.getSelectedIndex()+1)+""; 
            PreparedStatement st = con.prepareStatement(sql);
